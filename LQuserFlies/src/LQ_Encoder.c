...
void LQ_ENC_InitPin(uint8_t enc_num)
{
    ...
    switch(enc_num)//选择ENC模块
    {
        ...
        case 2:    //ENC2模块
        {
            IOMUXC_SetPinMux(IOMUXC_GPIO_B0_13_XBAR1_INOUT11, 1U); //GPIO_AD_B0_02 配置为 XBAR1_INOUT06   J1
            //IOMUXC_SetPinMux(
            ...
            //IOMUXC_SetPinMux(
             ...
             //   0U);                                    /* Software Input On Field: Input Path is determined by functionality */
            IOMUXC_SetPinConfig(IOMUXC_GPIO_B0_13_XBAR1_INOUT11, 0x10B0u);   /* GPIO_AD_B0_09 PAD functional properties : */
...
//        XBARA_SetSignalsConnection(XBARA1, kXBARA1_InputIomuxXbarInout14, kXBARA1_OutputEnc1Index);   //M14   Z相
    ...
    else if(base == ENC2) //ECL
    {
        ...
        XBARA_SetSignalsConnection(XBARA1, kXBARA1_InputIomuxXbarInout11, kXBARA1_OutputEnc2PhaseAInput);

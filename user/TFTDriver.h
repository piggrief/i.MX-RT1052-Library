...
#define DC(x)   	GPIO_PinWrite(BOARD_INITPINS_TFTDC_PORT, BOARD_INITPINS_TFTDC_PIN, x);
#define REST(x) 	GPIO_PinWrite(BOARD_INITPINS_TFTRES_PORT, BOARD_INITPINS_TFTRES_PIN, x);

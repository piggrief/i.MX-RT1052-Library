...
#define TFTSPI_CS(x)     GPIO_PinWrite(GPIO2, 19, x)//CS   D11
#define TFTSPI_SCL(x)    GPIO_PinWrite(GPIO2, 21, x)//SCL  D12
#define TFTSPI_SDA(x)    GPIO_PinWrite(GPIO2, 20, x)//SDI  E12
#define TFTSPI_DC(x)     GPIO_PinWrite(GPIO2, 15, x)//DC   E11
#define TFTSPI_RST(x)    GPIO_PinWrite(GPIO2, 26, x)//RST  B13
